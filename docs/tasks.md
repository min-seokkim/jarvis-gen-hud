...
gh repo create min-seokkim/jarvis-gen-hud --public \
...
git init -b main
git remote add origin https://github.com/min-seokkim/jarvis-gen-hud.git
...
git clone https://github.com/min-seokkim/jarvis-gen-hud.wiki.git
cd jarvis-gen-hud.wiki
...
## E. 1주차 체크리스트 (제출 기준)
- [ ] public repo `min-seokkim/jarvis-gen-hud` 생성
- [ ] `main`/`dev` 브랜치
